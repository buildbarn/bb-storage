...
func TestAuthenticatingUnaryInterceptor(t *testing.T) {
	...
	authenticator.EXPECT().Authenticate(ctx).Return(context.WithValue(ctx, CtxKey{}, "You're totally who you say you are"), nil)
	...
	t.Run("ReturnsModifiedCtx", func(t *testing.T) {
		handler.EXPECT().Call(gomock.Any(), req).DoAndReturn(
			func(ctx context.Context, req interface{}) (interface{}, error) {
				require.Equal(t, "You're totally who you say you are", ctx.Value(CtxKey{}))
				return resp, nil
			})
	...
	t.Run("ReturnsModifiedCtx", func(t *testing.T) {
		handler.EXPECT().Call(gomock.Any(), gomock.Any()).DoAndReturn(
			func(srv interface{}, stream grpc.ServerStream) error {
				require.Equal(t, "You're totally who you say you are", stream.Context().Value(CtxKey{}))
				return nil
			})
