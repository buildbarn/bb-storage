...
func TestLocalBlobAccessBlockRotationDuringRefreshInOldestBlock(t *testing.T) {
	...
	digestLocationMap.EXPECT().Put(digest1, gomock.Any(), local.Location{
		BlockID:     2,
		OffsetBytes: 0,
		SizeBytes:   5,
	})
	...
	digestLocationMap.EXPECT().Put(digest2, gomock.Any(), local.Location{
		BlockID:     3,
		OffsetBytes: 0,
		SizeBytes:   5,
	})
	...
	digestLocationMap.EXPECT().Put(digest3, gomock.Any(), local.Location{
		BlockID:     4,
		OffsetBytes: 0,
		SizeBytes:   5,
	})
	...
	digestLocationMap.EXPECT().Get(digest1, gomock.Any()).Return(local.Location{
		BlockID:     2,
		OffsetBytes: 0,
		SizeBytes:   5,
	}, nil).Times(2)
	...
	digestLocationMap.EXPECT().Get(digest2, gomock.Any()).Return(local.Location{
		BlockID:     3,
		OffsetBytes: 0,
		SizeBytes:   5,
	}, nil)
