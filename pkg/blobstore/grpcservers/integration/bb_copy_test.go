...
func TestBBCopyBlobReplication(t *testing.T) {
	...
	t.Run("CopyFromLargerChunkSource", func(t *testing.T) {
		...
		require.NoError(t, batchUploadBlob(ctx, sourceCASClient, data, dataDigest, remoteexecution.Compressor_IDENTITY))
...
func TestBBCopyCompositeReplication(t *testing.T) {
	...
	t.Run("CopyDirectory", func(t *testing.T) {
		...
		require.NoError(t, batchUploadBlob(ctx, sourceCASClient, fileData, fileDigest, remoteexecution.Compressor_IDENTITY))
		require.NoError(t, batchUploadBlob(ctx, sourceCASClient, subDirData, subDirDigest, remoteexecution.Compressor_IDENTITY))
		require.NoError(t, batchUploadBlob(ctx, sourceCASClient, rootDirData, rootDirDigest, remoteexecution.Compressor_IDENTITY))
	...
	t.Run("CopyTreeWithCDC", func(t *testing.T) {
		...
		require.NoError(t, batchUploadBlob(ctx, sourceCASClient, fileData, fileDigest, remoteexecution.Compressor_IDENTITY))
		require.NoError(t, batchUploadBlob(ctx, sourceCASClient, treeData, treeDigest, remoteexecution.Compressor_IDENTITY))
	...
	t.Run("CopyActionWithCDC", func(t *testing.T) {
		...
		require.NoError(t, batchUploadBlob(ctx, sourceCASClient, fileData, fileDigest, remoteexecution.Compressor_IDENTITY))
		require.NoError(t, batchUploadBlob(ctx, sourceCASClient, dirData, dirDigest, remoteexecution.Compressor_IDENTITY))
		require.NoError(t, batchUploadBlob(ctx, sourceCASClient, cmdData, cmdDigest, remoteexecution.Compressor_IDENTITY))
		require.NoError(t, batchUploadBlob(ctx, sourceCASClient, actionData, actionDigest, remoteexecution.Compressor_IDENTITY))
