...
type ReplicatorClient interface {
	ReplicateBlobs(ctx context.Context, in *ReplicateBlobsRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *replicatorClient) ReplicateBlobs(ctx context.Context, in *ReplicateBlobsRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type ReplicatorServer interface {
	ReplicateBlobs(context.Context, *ReplicateBlobsRequest) (*empty.Empty, error)
}
...
func (*UnimplementedReplicatorServer) ReplicateBlobs(context.Context, *ReplicateBlobsRequest) (*empty.Empty, error) {
