...
type AuthenticateRequest struct {
	...
	RequestMetadata map[string]*AuthenticateRequest_ValueList `protobuf:"bytes,1,rep,name=request_metadata,json=requestMetadata,proto3" json:"request_metadata,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (m *AuthenticateResponse) GetVerdict() isAuthenticateResponse_Verdict {
	if m != nil {
		return m.Verdict
	}
	return nil
...
func (x *AuthenticateResponse) GetAllow() *AuthenticationMetadata {
	if x, ok := x.GetVerdict().(*AuthenticateResponse_Allow); ok {
		return x.Allow
	}
	return nil
}
...
func (x *AuthenticateResponse) GetDeny() string {
	if x, ok := x.GetVerdict().(*AuthenticateResponse_Deny); ok {
		return x.Deny
	}
	return ""
}
...
func (m *AuthorizeResponse) GetVerdict() isAuthorizeResponse_Verdict {
	if m != nil {
		return m.Verdict
	}
	return nil
...
func (x *AuthorizeResponse) GetAllow() *emptypb.Empty {
	if x, ok := x.GetVerdict().(*AuthorizeResponse_Allow); ok {
		return x.Allow
	}
	return nil
}
...
func (x *AuthorizeResponse) GetDeny() string {
	if x, ok := x.GetVerdict().(*AuthorizeResponse_Deny); ok {
		return x.Deny
	}
	return ""
}
