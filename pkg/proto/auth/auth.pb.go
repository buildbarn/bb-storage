...
var file_pkg_proto_auth_auth_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa0, 0x01, 0x0a, 0x16, 0x41, 0x75, 0x74, 0x68, 0x65, 0x6e,
	...
	0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x42, 0x30, 0x5a, 0x2e, 0x67, 0x69, 0x74, 0x68,
...
func file_pkg_proto_auth_auth_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pkg_proto_auth_auth_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AuthenticationMetadata); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
