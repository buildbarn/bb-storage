...
const file_pkg_proto_configuration_auth_auth_proto_rawDesc = "" +
	"\n" +
	"'pkg/proto/configuration/auth/auth.proto\x12\x1cbuildbarn.configuration.auth\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a/pkg/proto/configuration/eviction/eviction.proto\x1a'pkg/proto/configuration/grpc/grpc.proto\x1a!pkg/proto/jmespath/jmespath.proto\"\x88\x03\n" +
	...
	"\x04deny\x18\x03 \x01(\v2\x16.google.protobuf.EmptyH\x00R\x04deny\x12Q\n" +
	"\x13jmespath_expression\x18\x04 \x01(\v2\x1e.buildbarn.jmespath.ExpressionH\x00R\x12jmespathExpression\x12H\n" +
...
var file_pkg_proto_configuration_auth_auth_proto_goTypes = []any{
	...
	(*jmespath.Expression)(nil),          // 4: buildbarn.jmespath.Expression
...
var file_pkg_proto_configuration_auth_auth_proto_depIdxs = []int32{
	...
	4, // 3: buildbarn.configuration.auth.AuthorizerConfiguration.jmespath_expression:type_name -> buildbarn.jmespath.Expression
