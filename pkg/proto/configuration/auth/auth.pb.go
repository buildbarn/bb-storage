...
func (x *AuthorizerConfiguration) GetAllow() *empty.Empty {
...
func (x *AuthorizerConfiguration) GetDeny() *empty.Empty {
...
type AuthorizerConfiguration_Deny struct {
	Deny *empty.Empty `protobuf:"bytes,3,opt,name=deny,proto3,oneof"`
}
