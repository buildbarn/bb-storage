...
const file_pkg_proto_configuration_jwt_jwt_proto_rawDesc = "" +
	"\n" +
	"%pkg/proto/configuration/jwt/jwt.proto\x12\x1bbuildbarn.configuration.jwt\x1a\x1cgoogle/protobuf/struct.proto\x1a/pkg/proto/configuration/eviction/eviction.proto\x1a!pkg/proto/jmespath/jmespath.proto\"\xa3\x04\n" +
	...
	"%claims_validation_jmespath_expression\x18\x05 \x01(\v2\x1e.buildbarn.jmespath.ExpressionR\"claimsValidationJmespathExpression\x12u\n" +
	"'metadata_extraction_jmespath_expression\x18\x06 \x01(\v2\x1e.buildbarn.jmespath.ExpressionR$metadataExtractionJmespathExpressionB\x06\n" +
...
var file_pkg_proto_configuration_jwt_jwt_proto_goTypes = []any{
	...
	(*jmespath.Expression)(nil),                    // 3: buildbarn.jmespath.Expression
}
var file_pkg_proto_configuration_jwt_jwt_proto_depIdxs = []int32{
	...
	3, // 2: buildbarn.configuration.jwt.AuthorizationHeaderParserConfiguration.claims_validation_jmespath_expression:type_name -> buildbarn.jmespath.Expression
	3, // 3: buildbarn.configuration.jwt.AuthorizationHeaderParserConfiguration.metadata_extraction_jmespath_expression:type_name -> buildbarn.jmespath.Expression
