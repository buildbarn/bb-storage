...
const file_pkg_proto_configuration_x509_x509_proto_rawDesc = "" +
	"\n" +
	"'pkg/proto/configuration/x509/x509.proto\x12\x1cbuildbarn.configuration.x509\x1a!pkg/proto/jmespath/jmespath.proto\"\xcb\x02\n" +
	...
	"\x1evalidation_jmespath_expression\x18\x02 \x01(\v2\x1e.buildbarn.jmespath.ExpressionR\x1cvalidationJmespathExpression\x12u\n" +
	"'metadata_extraction_jmespath_expression\x18\x03 \x01(\v2\x1e.buildbarn.jmespath.ExpressionR$metadataExtractionJmespathExpressionB>Z<github.com/buildbarn/bb-storage/pkg/proto/configuration/x509b\x06proto3"
...
var file_pkg_proto_configuration_x509_x509_proto_goTypes = []any{
	...
	(*jmespath.Expression)(nil),                    // 1: buildbarn.jmespath.Expression
}
var file_pkg_proto_configuration_x509_x509_proto_depIdxs = []int32{
	1, // 0: buildbarn.configuration.x509.ClientCertificateVerifierConfiguration.validation_jmespath_expression:type_name -> buildbarn.jmespath.Expression
	1, // 1: buildbarn.configuration.x509.ClientCertificateVerifierConfiguration.metadata_extraction_jmespath_expression:type_name -> buildbarn.jmespath.Expression
