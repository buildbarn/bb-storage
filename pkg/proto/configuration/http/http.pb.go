...
const file_pkg_proto_configuration_http_http_proto_rawDesc = "" +
	...
	"\bpolicies\x18\x01 \x03(\v22.buildbarn.configuration.http.AuthenticationPolicyR\bpolicies\"\x83\x05\n" +
	...
	"'metadata_extraction_jmespath_expression\x18\x06 \x01(\v2\x1e.buildbarn.jmespath.ExpressionR$metadataExtractionJmespathExpression\x12!\n" +
...
var file_pkg_proto_configuration_http_http_proto_goTypes = []any{
	...
	(*jmespath.Expression)(nil),                        // 13: buildbarn.jmespath.Expression
}
var file_pkg_proto_configuration_http_http_proto_depIdxs = []int32{
	...
	13, // 12: buildbarn.configuration.http.OIDCAuthenticationPolicy.metadata_extraction_jmespath_expression:type_name -> buildbarn.jmespath.Expression
