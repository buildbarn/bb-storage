...
import (
	_ "github.com/buildbarn/bb-storage/pkg/proto/configuration/http"
...
var file_pkg_proto_configuration_cloud_gcp_gcp_proto_rawDesc = []byte{
	...
	0x74, 0x74, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x1c, 0x0a, 0x1a, 0x43, 0x6c, 0x69,
	...
	0x6f, 0x6e, 0x2f, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2f, 0x67, 0x63, 0x70, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_pkg_proto_configuration_cloud_gcp_gcp_proto_rawDescOnce sync.Once
	file_pkg_proto_configuration_cloud_gcp_gcp_proto_rawDescData = file_pkg_proto_configuration_cloud_gcp_gcp_proto_rawDesc
)
...
func file_pkg_proto_configuration_cloud_gcp_gcp_proto_rawDescGZIP() []byte {
	file_pkg_proto_configuration_cloud_gcp_gcp_proto_rawDescOnce.Do(func() {
		file_pkg_proto_configuration_cloud_gcp_gcp_proto_rawDescData = protoimpl.X.CompressGZIP(file_pkg_proto_configuration_cloud_gcp_gcp_proto_rawDescData)
	})
...
var file_pkg_proto_configuration_cloud_gcp_gcp_proto_goTypes = []interface{}{
...
func file_pkg_proto_configuration_cloud_gcp_gcp_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pkg_proto_configuration_cloud_gcp_gcp_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ClientOptionsConfiguration); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_pkg_proto_configuration_cloud_gcp_gcp_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_pkg_proto_configuration_cloud_gcp_gcp_proto_rawDesc = nil
