...
var file_pkg_proto_configuration_bb_copy_bb_copy_proto_goTypes = []interface{}{
...
func file_pkg_proto_configuration_bb_copy_bb_copy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pkg_proto_configuration_bb_copy_bb_copy_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
