...
func (x *ClientKeepaliveConfiguration) GetTime() *duration.Duration {
	if x != nil {
		return x.Time
	}
	return nil
...
func (x *ClientKeepaliveConfiguration) GetTimeout() *duration.Duration {
	if x != nil {
		return x.Timeout
	}
	return nil
...
func (x *ClientOAuthConfiguration) GetGoogleDefaultCredentials() *empty.Empty {
...
type ClientOAuthConfiguration_GoogleDefaultCredentials struct {
	GoogleDefaultCredentials *empty.Empty `protobuf:"bytes,1,opt,name=google_default_credentials,json=googleDefaultCredentials,proto3,oneof"`
}
...
type ServerKeepaliveEnforcementPolicy struct {
	...
	MinTime             *duration.Duration `protobuf:"bytes,1,opt,name=min_time,json=minTime,proto3" json:"min_time,omitempty"`
...
func (x *ServerKeepaliveEnforcementPolicy) GetMinTime() *duration.Duration {
	if x != nil {
		return x.MinTime
	}
	return nil
...
func (x *AuthenticationPolicy) GetAllow() *empty.Empty {
