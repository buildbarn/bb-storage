...
import (
	...
	jmespath "github.com/buildbarn/bb-storage/pkg/proto/jmespath"
...
const file_pkg_proto_configuration_grpc_grpc_proto_rawDesc = "" +
	...
	" add_metadata_jmespath_expression\x18\f \x01(\v2\x1e.buildbarn.jmespath.ExpressionR\x1daddMetadataJmespathExpression\x12L\n" +
	...
	"\atimeout\x18\x05 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xaa\x05\n" +
	...
	"$peer_credentials_jmespath_expression\x18\x06 \x01(\v2\x1e.buildbarn.jmespath.ExpressionH\x00R!peerCredentialsJmespathExpression\x12R\n" +
	...
	"\bpolicies\x18\x01 \x03(\v22.buildbarn.configuration.grpc.AuthenticationPolicyR\bpolicies\"\xd3\x02\n" +
	...
	"\x1evalidation_jmespath_expression\x18\x03 \x01(\v2\x1e.buildbarn.jmespath.ExpressionR\x1cvalidationJmespathExpression\x12u\n" +
	"'metadata_extraction_jmespath_expression\x18\x04 \x01(\v2\x1e.buildbarn.jmespath.ExpressionR$metadataExtractionJmespathExpressionJ\x04\b\x02\x10\x03\"\xd5\x02\n" +
...
var file_pkg_proto_configuration_grpc_grpc_proto_goTypes = []any{
	...
	(*jmespath.Expression)(nil),                         // 16: buildbarn.jmespath.Expression
...
var file_pkg_proto_configuration_grpc_grpc_proto_depIdxs = []int32{
	...
	16, // 3: buildbarn.configuration.grpc.ClientConfiguration.add_metadata_jmespath_expression:type_name -> buildbarn.jmespath.Expression
	...
	16, // 26: buildbarn.configuration.grpc.AuthenticationPolicy.peer_credentials_jmespath_expression:type_name -> buildbarn.jmespath.Expression
	...
	16, // 30: buildbarn.configuration.grpc.TLSClientCertificateAuthenticationPolicy.validation_jmespath_expression:type_name -> buildbarn.jmespath.Expression
	16, // 31: buildbarn.configuration.grpc.TLSClientCertificateAuthenticationPolicy.metadata_extraction_jmespath_expression:type_name -> buildbarn.jmespath.Expression
